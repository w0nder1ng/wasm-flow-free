...
export function canvas_handle_md(a: number, b: number, c: number): void;
export function canvas_handle_mu(a: number): void;
export function canvas_handle_mm(a: number, b: number, c: number): void;
export function canvas_handle_keypress(a: number, b: number, c: number): void;
export function canvas_box_md(a: number, b: number, c: number, d: number): void;
